...
def run_tests(
    ...
    print(f"tests: {tests}, verbose: {verbose}, sequential: {sequential}, workers: {workers}, iterations: {iterations}, output: {output}, archive: {archive}")
        ...
        with Live(progress_table, transient=True) as live:
            ...
            with ThreadPoolExecutor(max_workers=workers) as executor:
                ...
                while completed < total:
                    ...
                    for future in done:
                        test, path, returnCode, runtime = future.result()
